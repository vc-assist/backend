...
// @generated from file cmd/vchsd/api/student_data.proto (package cmd.vchsd.api, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message cmd.vchsd.api.Assignment
 */
export class Assignment extends Message<Assignment> {
  ...
  static readonly typeName = "cmd.vchsd.api.Assignment";
...
/**
 * @generated from message cmd.vchsd.api.CourseMeeting
 */
export class CourseMeeting extends Message<CourseMeeting> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cmd.vchsd.api.CourseMeeting";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message cmd.vchsd.api.AssignmentType
 */
export class AssignmentType extends Message<AssignmentType> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cmd.vchsd.api.AssignmentType";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message cmd.vchsd.api.GradeSnapshot
 */
export class GradeSnapshot extends Message<GradeSnapshot> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cmd.vchsd.api.GradeSnapshot";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message cmd.vchsd.api.Course
 */
export class Course extends Message<Course> {
  ...
  /**
   * @generated from field: repeated cmd.vchsd.api.CourseMeeting meetings = 9;
   */
  meetings: CourseMeeting[] = [];

  /**
   * @generated from field: repeated cmd.vchsd.api.AssignmentType assignment_types = 10;
   */
  assignmentTypes: AssignmentType[] = [];

  /**
   * @generated from field: repeated cmd.vchsd.api.Assignment assignments = 11;
   */
  assignments: Assignment[] = [];

  /**
   * @generated from field: repeated cmd.vchsd.api.GradeSnapshot snapshots = 12;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cmd.vchsd.api.Course";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message cmd.vchsd.api.StudentData
 */
export class StudentData extends Message<StudentData> {
  ...
  /**
   * @generated from field: repeated cmd.vchsd.api.Course courses = 3;
   */
  courses: Course[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cmd.vchsd.api.StudentData";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
