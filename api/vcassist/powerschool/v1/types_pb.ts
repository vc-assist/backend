...
// @generated from file vcassist/powerschool/v1/types.proto (package vcassist.powerschool.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
export class AssignmentData extends Message<AssignmentData> {
  ...
  static readonly typeName = "vcassist.powerschool.v1.AssignmentData";
...
/**
 * @generated from message vcassist.powerschool.v1.Meeting
 */
export class Meeting extends Message<Meeting> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vcassist.powerschool.v1.Meeting";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message vcassist.powerschool.v1.AssignmentCategory
 */
export class AssignmentCategory extends Message<AssignmentCategory> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vcassist.powerschool.v1.AssignmentCategory";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message vcassist.powerschool.v1.GradeSnapshot
 */
...
/**
 * @generated from message vcassist.powerschool.v1.CourseData
 */
export class CourseData extends Message<CourseData> {
  ...
  /**
   * @generated from field: repeated vcassist.powerschool.v1.AssignmentData assignments = 10;
   */
  assignments: AssignmentData[] = [];

  /**
   * @generated from field: repeated vcassist.powerschool.v1.Meeting meetings = 11;
   */
  meetings: Meeting[] = [];

  /**
   * @generated from field: repeated vcassist.powerschool.v1.GradeSnapshot snapshots = 12;
   */
  snapshots: GradeSnapshot[] = [];

  /**
   * @generated from field: repeated vcassist.powerschool.v1.AssignmentCategory assignment_categories = 13;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vcassist.powerschool.v1.CourseData";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message vcassist.powerschool.v1.SchoolData
 */
export class SchoolData extends Message<SchoolData> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vcassist.powerschool.v1.SchoolData";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message vcassist.powerschool.v1.Bulletin
 */
export class Bulletin extends Message<Bulletin> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vcassist.powerschool.v1.Bulletin";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "title", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message vcassist.powerschool.v1.StudentProfile
 */
