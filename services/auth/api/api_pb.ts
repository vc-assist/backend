...
/**
 * @generated from message cmd.authd.api.StartLoginRequest
 */
export class StartLoginRequest extends Message<StartLoginRequest> {
  ...
  static readonly typeName = "cmd.authd.api.StartLoginRequest";
...
/**
 * @generated from message cmd.authd.api.StartLoginResponse
 */
export class StartLoginResponse extends Message<StartLoginResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cmd.authd.api.StartLoginResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message cmd.authd.api.ConsumeVerificationCodeRequest
 */
export class ConsumeVerificationCodeRequest extends Message<ConsumeVerificationCodeRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cmd.authd.api.ConsumeVerificationCodeRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "email", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message cmd.authd.api.ConsumeVerificationCodeResponse
 */
export class ConsumeVerificationCodeResponse extends Message<ConsumeVerificationCodeResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cmd.authd.api.ConsumeVerificationCodeResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message cmd.authd.api.VerifyTokenRequest
 */
export class VerifyTokenRequest extends Message<VerifyTokenRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cmd.authd.api.VerifyTokenRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "token", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message cmd.authd.api.VerifyTokenResponse
 */
export class VerifyTokenResponse extends Message<VerifyTokenResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cmd.authd.api.VerifyTokenResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "email", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
