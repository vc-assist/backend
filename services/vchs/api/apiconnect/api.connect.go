...
import (
	...
	http "net/http"
	strings "strings"
	api "vcassist-backend/services/vchs/api"
)
...
const (
	...
	VchsServiceName = "services.vchs.api.VchsService"
)
...
const (
	...
	VchsServiceGetCredentialStatusProcedure = "/services.vchs.api.VchsService/GetCredentialStatus"
	// VchsServiceProvidePowerschoolTokenProcedure is the fully-qualified name of the VchsService's
	// ProvidePowerschoolToken RPC.
	VchsServiceProvidePowerschoolTokenProcedure = "/services.vchs.api.VchsService/ProvidePowerschoolToken"
	// VchsServiceProvideMoodleLoginProcedure is the fully-qualified name of the VchsService's
	// ProvideMoodleLogin RPC.
	VchsServiceProvideMoodleLoginProcedure = "/services.vchs.api.VchsService/ProvideMoodleLogin"
	// VchsServiceGetStudentDataProcedure is the fully-qualified name of the VchsService's
	// GetStudentData RPC.
	VchsServiceGetStudentDataProcedure = "/services.vchs.api.VchsService/GetStudentData"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	vchsServiceServiceDescriptor                       = api.File_services_vchs_api_api_proto.Services().ByName("VchsService")
...
// VchsServiceClient is a client for the services.vchs.api.VchsService service.
...
// NewVchsServiceClient constructs a client for the services.vchs.api.VchsService service. By
...
// GetCredentialStatus calls services.vchs.api.VchsService.GetCredentialStatus.
...
// ProvidePowerschoolToken calls services.vchs.api.VchsService.ProvidePowerschoolToken.
...
// ProvideMoodleLogin calls services.vchs.api.VchsService.ProvideMoodleLogin.
...
// GetStudentData calls services.vchs.api.VchsService.GetStudentData.
...
// VchsServiceHandler is an implementation of the services.vchs.api.VchsService service.
...
func NewVchsServiceHandler(svc VchsServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/services.vchs.api.VchsService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
