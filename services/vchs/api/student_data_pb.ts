...
// @generated from file services/vchs/api/student_data.proto (package services.vchs.api, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
export class Assignment extends Message<Assignment> {
  ...
  static readonly typeName = "services.vchs.api.Assignment";
...
/**
 * @generated from message services.vchs.api.CourseMeeting
 */
export class CourseMeeting extends Message<CourseMeeting> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "services.vchs.api.CourseMeeting";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message services.vchs.api.AssignmentType
 */
export class AssignmentType extends Message<AssignmentType> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "services.vchs.api.AssignmentType";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message services.vchs.api.GradeSnapshot
 */
export class GradeSnapshot extends Message<GradeSnapshot> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "services.vchs.api.GradeSnapshot";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message services.vchs.api.Course
 */
export class Course extends Message<Course> {
  ...
  /**
   * @generated from field: repeated services.vchs.api.CourseMeeting meetings = 9;
   */
  meetings: CourseMeeting[] = [];

  /**
   * @generated from field: repeated services.vchs.api.AssignmentType assignment_types = 10;
   */
  assignmentTypes: AssignmentType[] = [];

  /**
   * @generated from field: repeated services.vchs.api.Assignment assignments = 11;
   */
  assignments: Assignment[] = [];

  /**
   * @generated from field: repeated services.vchs.api.GradeSnapshot snapshots = 12;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "services.vchs.api.Course";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message services.vchs.api.StudentData
 */
export class StudentData extends Message<StudentData> {
  ...
  /**
   * @generated from field: repeated services.vchs.api.Course courses = 3;
   */
  courses: Course[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "services.vchs.api.StudentData";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
