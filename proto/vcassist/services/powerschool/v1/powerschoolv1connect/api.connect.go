...
import (
	...
	http "net/http"
	strings "strings"
	v1 "vcassist-backend/proto/vcassist/services/powerschool/v1"
)
...
const (
	...
	PowerschoolServiceName = "vcassist.services.powerschool.v1.PowerschoolService"
)
...
const (
	...
	// GetAuthStatus RPC.
	PowerschoolServiceGetAuthStatusProcedure = "/vcassist.services.powerschool.v1.PowerschoolService/GetAuthStatus"
	// PowerschoolServiceGetOAuthFlowProcedure is the fully-qualified name of the PowerschoolService's
	// GetOAuthFlow RPC.
	PowerschoolServiceGetOAuthFlowProcedure = "/vcassist.services.powerschool.v1.PowerschoolService/GetOAuthFlow"
	// PowerschoolServiceProvideOAuthProcedure is the fully-qualified name of the PowerschoolService's
	// ProvideOAuth RPC.
	PowerschoolServiceProvideOAuthProcedure = "/vcassist.services.powerschool.v1.PowerschoolService/ProvideOAuth"
	// PowerschoolServiceGetStudentDataProcedure is the fully-qualified name of the PowerschoolService's
	// GetStudentData RPC.
	PowerschoolServiceGetStudentDataProcedure = "/vcassist.services.powerschool.v1.PowerschoolService/GetStudentData"
	// PowerschoolServiceGetKnownCoursesProcedure is the fully-qualified name of the
	// PowerschoolService's GetKnownCourses RPC.
	PowerschoolServiceGetKnownCoursesProcedure = "/vcassist.services.powerschool.v1.PowerschoolService/GetKnownCourses"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	powerschoolServiceServiceDescriptor               = v1.File_vcassist_services_powerschool_v1_api_proto.Services().ByName("PowerschoolService")
...
// PowerschoolServiceClient is a client for the vcassist.services.powerschool.v1.PowerschoolService
// service.
type PowerschoolServiceClient interface {
	...
	GetKnownCourses(context.Context, *connect.Request[v1.GetKnownCoursesRequest]) (*connect.Response[v1.GetKnownCoursesResponse], error)
}

// NewPowerschoolServiceClient constructs a client for the
// vcassist.services.powerschool.v1.PowerschoolService service. By default, it uses the Connect
...
func NewPowerschoolServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) PowerschoolServiceClient {
	...
	return &powerschoolServiceClient{
		...
		getKnownCourses: connect.NewClient[v1.GetKnownCoursesRequest, v1.GetKnownCoursesResponse](
			httpClient,
...
type powerschoolServiceClient struct {
	...
	getKnownCourses *connect.Client[v1.GetKnownCoursesRequest, v1.GetKnownCoursesResponse]
}

// GetAuthStatus calls vcassist.services.powerschool.v1.PowerschoolService.GetAuthStatus.
...
// GetOAuthFlow calls vcassist.services.powerschool.v1.PowerschoolService.GetOAuthFlow.
...
// ProvideOAuth calls vcassist.services.powerschool.v1.PowerschoolService.ProvideOAuth.
...
// GetStudentData calls vcassist.services.powerschool.v1.PowerschoolService.GetStudentData.
...
// GetKnownCourses calls vcassist.services.powerschool.v1.PowerschoolService.GetKnownCourses.
func (c *powerschoolServiceClient) GetKnownCourses(ctx context.Context, req *connect.Request[v1.GetKnownCoursesRequest]) (*connect.Response[v1.GetKnownCoursesResponse], error) {
	return c.getKnownCourses.CallUnary(ctx, req)
}

// PowerschoolServiceHandler is an implementation of the
// vcassist.services.powerschool.v1.PowerschoolService service.
...
func NewPowerschoolServiceHandler(svc PowerschoolServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/vcassist.services.powerschool.v1.PowerschoolService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPowerschoolServiceHandler) GetAuthStatus(context.Context, *connect.Request[v1.GetAuthStatusRequest]) (*connect.Response[v1.GetAuthStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vcassist.services.powerschool.v1.PowerschoolService.GetAuthStatus is not implemented"))
}
...
func (UnimplementedPowerschoolServiceHandler) GetOAuthFlow(context.Context, *connect.Request[v1.GetOAuthFlowRequest]) (*connect.Response[v1.GetOAuthFlowResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vcassist.services.powerschool.v1.PowerschoolService.GetOAuthFlow is not implemented"))
}
...
func (UnimplementedPowerschoolServiceHandler) ProvideOAuth(context.Context, *connect.Request[v1.ProvideOAuthRequest]) (*connect.Response[v1.ProvideOAuthResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vcassist.services.powerschool.v1.PowerschoolService.ProvideOAuth is not implemented"))
}
...
func (UnimplementedPowerschoolServiceHandler) GetStudentData(context.Context, *connect.Request[v1.GetStudentDataRequest]) (*connect.Response[v1.GetStudentDataResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vcassist.services.powerschool.v1.PowerschoolService.GetStudentData is not implemented"))
}

func (UnimplementedPowerschoolServiceHandler) GetKnownCourses(context.Context, *connect.Request[v1.GetKnownCoursesRequest]) (*connect.Response[v1.GetKnownCoursesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vcassist.services.powerschool.v1.PowerschoolService.GetKnownCourses is not implemented"))
}
