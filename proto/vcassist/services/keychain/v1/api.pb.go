...
type SetSessionTokenRequest struct {
	...
	UsernamePassword *SetSessionTokenRequest_UsernamePassword `protobuf:"bytes,2,opt,name=username_password,json=usernamePassword,proto3,oneof" json:"username_password,omitempty"` //could be either one or both inputted
	OauthFeilds      *SetSessionTokenRequest_OAuthFeilds      `protobuf:"bytes,3,opt,name=oauth_feilds,json=oauthFeilds,proto3,oneof" json:"oauth_feilds,omitempty"`                // this is for all of our oath paraemeters alot
}

func (x *SetSessionTokenRequest) Reset() {
	*x = SetSessionTokenRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vcassist_services_keychain_v1_api_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SetSessionTokenRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetSessionTokenRequest) ProtoMessage() {}

func (x *SetSessionTokenRequest) ProtoReflect() protoreflect.Message {
	mi := &file_vcassist_services_keychain_v1_api_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetSessionTokenRequest.ProtoReflect.Descriptor instead.
func (*SetSessionTokenRequest) Descriptor() ([]byte, []int) {
	return file_vcassist_services_keychain_v1_api_proto_rawDescGZIP(), []int{10}
}

func (x *SetSessionTokenRequest) GetOauthToken() string {
	if x != nil {
		return x.OauthToken
	}
	return ""
...
func (x *SetSessionTokenRequest) GetUsernamePassword() *SetSessionTokenRequest_UsernamePassword {
	if x != nil {
...
func (x *SetSessionTokenRequest) GetOauthFeilds() *SetSessionTokenRequest_OAuthFeilds {
	if x != nil {
		return x.OauthFeilds
	}
	return nil
}

type SetSessionTokenResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	SessionToken string `protobuf:"bytes,1,opt,name=sessionToken,proto3" json:"sessionToken,omitempty"` //token is nil if does not exist
}

func (x *SetSessionTokenResponse) Reset() {
	*x = SetSessionTokenResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vcassist_services_keychain_v1_api_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SetSessionTokenResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetSessionTokenResponse) ProtoMessage() {}

func (x *SetSessionTokenResponse) ProtoReflect() protoreflect.Message {
	mi := &file_vcassist_services_keychain_v1_api_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetSessionTokenResponse.ProtoReflect.Descriptor instead.
func (*SetSessionTokenResponse) Descriptor() ([]byte, []int) {
	return file_vcassist_services_keychain_v1_api_proto_rawDescGZIP(), []int{11}
}

func (x *SetSessionTokenResponse) GetSessionToken() string {
	if x != nil {
...
type SetSessionTokenRequest_UsernamePassword struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SetSessionTokenRequest_UsernamePassword) Reset() {
	*x = SetSessionTokenRequest_UsernamePassword{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vcassist_services_keychain_v1_api_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SetSessionTokenRequest_UsernamePassword) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetSessionTokenRequest_UsernamePassword) ProtoMessage() {}

func (x *SetSessionTokenRequest_UsernamePassword) ProtoReflect() protoreflect.Message {
	mi := &file_vcassist_services_keychain_v1_api_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetSessionTokenRequest_UsernamePassword.ProtoReflect.Descriptor instead.
func (*SetSessionTokenRequest_UsernamePassword) Descriptor() ([]byte, []int) {
	return file_vcassist_services_keychain_v1_api_proto_rawDescGZIP(), []int{10, 0}
}

func (x *SetSessionTokenRequest_UsernamePassword) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *SetSessionTokenRequest_UsernamePassword) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
type SetSessionTokenRequest_OAuthFeilds struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SetSessionTokenRequest_OAuthFeilds) Reset() {
	*x = SetSessionTokenRequest_OAuthFeilds{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vcassist_services_keychain_v1_api_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SetSessionTokenRequest_OAuthFeilds) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetSessionTokenRequest_OAuthFeilds) ProtoMessage() {}

func (x *SetSessionTokenRequest_OAuthFeilds) ProtoReflect() protoreflect.Message {
	mi := &file_vcassist_services_keychain_v1_api_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetSessionTokenRequest_OAuthFeilds.ProtoReflect.Descriptor instead.
func (*SetSessionTokenRequest_OAuthFeilds) Descriptor() ([]byte, []int) {
	return file_vcassist_services_keychain_v1_api_proto_rawDescGZIP(), []int{10, 1}
}

func (x *SetSessionTokenRequest_OAuthFeilds) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *SetSessionTokenRequest_OAuthFeilds) GetRefreshUrl() string {
	if x != nil {
		return x.RefreshUrl
	}
	return ""
...
func (x *SetSessionTokenRequest_OAuthFeilds) GetClientId() string {
	if x != nil {
		return x.ClientId
	}
	return ""
...
func (x *SetSessionTokenRequest_OAuthFeilds) GetExpiresAt() int64 {
	if x != nil {
		return x.ExpiresAt
	}
	return 0
...
var file_vcassist_services_keychain_v1_api_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x65, 0x73, 0x2e, 0x6b, 0x65, 0x79, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x76, 0x31,
	0x2e, 0x55, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72,
	0x64, 0x4b, 0x65, 0x79, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x22, 0x94, 0x04, 0x0a, 0x16, 0x53, 0x65,
	0x74, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71,
	...
	,
	...
	,
	...
	,
...
var file_vcassist_services_keychain_v1_api_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_vcassist_services_keychain_v1_api_proto_goTypes = []any{
	...
	(*SetSessionTokenRequest)(nil),                  // 10: vcassist.services.keychain.v1.SetSessionTokenRequest
	(*SetSessionTokenResponse)(nil),                 // 11: vcassist.services.keychain.v1.SetSessionTokenResponse
	(*SetSessionTokenRequest_UsernamePassword)(nil), // 12: vcassist.services.keychain.v1.SetSessionTokenRequest.UsernamePassword
	(*SetSessionTokenRequest_OAuthFeilds)(nil),      // 13: vcassist.services.keychain.v1.SetSessionTokenRequest.OAuthFeilds
}
var file_vcassist_services_keychain_v1_api_proto_depIdxs = []int32{
	...
	12, // 4: vcassist.services.keychain.v1.SetSessionTokenRequest.username_password:type_name -> vcassist.services.keychain.v1.SetSessionTokenRequest.UsernamePassword
	13, // 5: vcassist.services.keychain.v1.SetSessionTokenRequest.oauth_feilds:type_name -> vcassist.services.keychain.v1.SetSessionTokenRequest.OAuthFeilds
	2,  // 6: vcassist.services.keychain.v1.KeychainService.SetOAuth:input_type -> vcassist.services.keychain.v1.SetOAuthRequest
	6,  // 7: vcassist.services.keychain.v1.KeychainService.GetOAuth:input_type -> vcassist.services.keychain.v1.GetOAuthRequest
	10, // 8: vcassist.services.keychain.v1.KeychainService.SetSessionToken:input_type -> vcassist.services.keychain.v1.SetSessionTokenRequest
	4,  // 9: vcassist.services.keychain.v1.KeychainService.SetUsernamePassword:input_type -> vcassist.services.keychain.v1.SetUsernamePasswordRequest
	8,  // 10: vcassist.services.keychain.v1.KeychainService.GetUsernamePassword:input_type -> vcassist.services.keychain.v1.GetUsernamePasswordRequest
	3,  // 11: vcassist.services.keychain.v1.KeychainService.SetOAuth:output_type -> vcassist.services.keychain.v1.SetOAuthResponse
	7,  // 12: vcassist.services.keychain.v1.KeychainService.GetOAuth:output_type -> vcassist.services.keychain.v1.GetOAuthResponse
	11, // 13: vcassist.services.keychain.v1.KeychainService.SetSessionToken:output_type -> vcassist.services.keychain.v1.SetSessionTokenResponse
	5,  // 14: vcassist.services.keychain.v1.KeychainService.SetUsernamePassword:output_type -> vcassist.services.keychain.v1.SetUsernamePasswordResponse
	9,  // 15: vcassist.services.keychain.v1.KeychainService.GetUsernamePassword:output_type -> vcassist.services.keychain.v1.GetUsernamePasswordResponse
...
func file_vcassist_services_keychain_v1_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vcassist_services_keychain_v1_api_proto_msgTypes[10].Exporter = func(v any, i int) any {
			switch v := v.(*SetSessionTokenRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_vcassist_services_keychain_v1_api_proto_msgTypes[11].Exporter = func(v any, i int) any {
			switch v := v.(*SetSessionTokenResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_vcassist_services_keychain_v1_api_proto_msgTypes[12].Exporter = func(v any, i int) any {
			switch v := v.(*SetSessionTokenRequest_UsernamePassword); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_vcassist_services_keychain_v1_api_proto_msgTypes[13].Exporter = func(v any, i int) any {
			switch v := v.(*SetSessionTokenRequest_OAuthFeilds); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_vcassist_services_keychain_v1_api_proto_msgTypes[10].OneofWrappers = []any{}
	type x struct{}
