...
/**
 * @generated from message vcassist.services.auth.v1.LinkParentRequest
 */
export class LinkParentRequest extends Message<LinkParentRequest> {
  /**
   * @generated from field: string token = 1;
   */
  token = "";
  ...
  constructor(data?: PartialMessage<LinkParentRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): LinkParentRequest {
    return new LinkParentRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): LinkParentRequest {
    return new LinkParentRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): LinkParentRequest {
    return new LinkParentRequest().fromJsonString(jsonString, options);
  }

  static equals(a: LinkParentRequest | PlainMessage<LinkParentRequest> | undefined, b: LinkParentRequest | PlainMessage<LinkParentRequest> | undefined): boolean {
    return proto3.util.equals(LinkParentRequest, a, b);
  }
}

/**
 * @generated from message vcassist.services.auth.v1.LinkParentResponse
 */
export class LinkParentResponse extends Message<LinkParentResponse> {
  /**
   * return both emails for debugging purposes
   *
   * @generated from field: string userEmail = 1;
   */
  userEmail = "";

  /**
   * @generated from field: string parentEmail = 2;
   */
  parentEmail = "";

  constructor(data?: PartialMessage<LinkParentResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vcassist.services.auth.v1.LinkParentResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "userEmail", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "parentEmail", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): LinkParentResponse {
    return new LinkParentResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): LinkParentResponse {
    return new LinkParentResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): LinkParentResponse {
    return new LinkParentResponse().fromJsonString(jsonString, options);
  }

  static equals(a: LinkParentResponse | PlainMessage<LinkParentResponse> | undefined, b: LinkParentResponse | PlainMessage<LinkParentResponse> | undefined): boolean {
    return proto3.util.equals(LinkParentResponse, a, b);
  }
}
