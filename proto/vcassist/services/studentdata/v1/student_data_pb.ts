...
proto3.util.setEnumType(AssignmentState, "vcassist.services.studentdata.v1.AssignmentState", [
  { no: 0, name: "ASSIGNMENT_STATE_UNSPECIFIED" },
  { no: 1, name: "ASSIGNMENT_STATE_MISSING" },
  { no: 2, name: "ASSIGNMENT_STATE_INCOMPLETE" },
  { no: 3, name: "ASSIGNMENT_STATE_SUBMITTED" },
  { no: 4, name: "ASSIGNMENT_STATE_LATE" },
  { no: 5, name: "ASSIGNMENT_STATE_EXEMPT" },
]);
...
export class Assignment extends Message<Assignment> {
  ...
  static readonly typeName = "vcassist.services.studentdata.v1.Assignment";
...
export class CourseMeeting extends Message<CourseMeeting> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vcassist.services.studentdata.v1.CourseMeeting";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class AssignmentType extends Message<AssignmentType> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vcassist.services.studentdata.v1.AssignmentType";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
export class GradeSnapshot extends Message<GradeSnapshot> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vcassist.services.studentdata.v1.GradeSnapshot";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class Course extends Message<Course> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vcassist.services.studentdata.v1.Course";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
export class StudentData extends Message<StudentData> {
  ...
  /**
   * @generated from field: bytes photo = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vcassist.services.studentdata.v1.StudentData";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "gpa", kind: "scalar", T: 2 /* ScalarType.FLOAT */ },
    { no: 2, name: "current_day", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "photo", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
    { no: 4, name: "day_names", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
    { no: 5, name: "courses", kind: "message", T: Course, repeated: true },
  ]);
