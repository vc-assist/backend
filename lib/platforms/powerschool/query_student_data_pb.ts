...
// @generated from file lib/platforms/powerschool/query_student_data.proto (package lib.platforms.powerschool, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message lib.platforms.powerschool.TermData
 */
export class TermData extends Message<TermData> {
  ...
  /**
   * @generated from field: lib.platforms.powerschool.TermData.FinalGrade final_grade = 3;
   */
  ...
  static readonly typeName = "lib.platforms.powerschool.TermData";
...
/**
 * @generated from message lib.platforms.powerschool.TermData.FinalGrade
 */
export class TermData_FinalGrade extends Message<TermData_FinalGrade> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "lib.platforms.powerschool.TermData.FinalGrade";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message lib.platforms.powerschool.AssignmentData
 */
export class AssignmentData extends Message<AssignmentData> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "lib.platforms.powerschool.AssignmentData";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message lib.platforms.powerschool.CourseData
 */
export class CourseData extends Message<CourseData> {
  ...
  /**
   * @generated from field: repeated lib.platforms.powerschool.AssignmentData assignments = 8;
   */
  assignments: AssignmentData[] = [];

  /**
   * @generated from field: repeated lib.platforms.powerschool.TermData terms = 9;
   */
  terms: TermData[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "lib.platforms.powerschool.CourseData";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message lib.platforms.powerschool.StudentData
 */
export class StudentData extends Message<StudentData> {
  /**
   * @generated from field: lib.platforms.powerschool.StudentData.Student student = 1 [json_name = "guid"];
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "lib.platforms.powerschool.StudentData";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message lib.platforms.powerschool.StudentData.Student
 */
export class StudentData_Student extends Message<StudentData_Student> {
  /**
   * @generated from field: repeated lib.platforms.powerschool.CourseData sections = 1;
   */
  sections: CourseData[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "lib.platforms.powerschool.StudentData.Student";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message lib.platforms.powerschool.GetStudentDataInput
 */
export class GetStudentDataInput extends Message<GetStudentDataInput> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "lib.platforms.powerschool.GetStudentDataInput";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "guid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
