...
// @generated from file lib/scrapers/powerschool/query_all_students.proto (package lib.scrapers.powerschool, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message lib.scrapers.powerschool.SchoolData
 */
export class SchoolData extends Message<SchoolData> {
  ...
  static readonly typeName = "lib.scrapers.powerschool.SchoolData";
...
/**
 * @generated from message lib.scrapers.powerschool.Bulletin
 */
export class Bulletin extends Message<Bulletin> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "lib.scrapers.powerschool.Bulletin";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message lib.scrapers.powerschool.StudentProfile
 */
export class StudentProfile extends Message<StudentProfile> {
  ...
  /**
   * @generated from field: repeated lib.scrapers.powerschool.SchoolData schools = 6;
   */
  schools: SchoolData[] = [];

  /**
   * @generated from field: repeated lib.scrapers.powerschool.Bulletin bulletins = 7;
   */
  bulletins: Bulletin[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "lib.scrapers.powerschool.StudentProfile";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message lib.scrapers.powerschool.AllStudents
 */
export class AllStudents extends Message<AllStudents> {
  /**
   * @generated from field: repeated lib.scrapers.powerschool.StudentProfile students = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "lib.scrapers.powerschool.AllStudents";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message lib.scrapers.powerschool.GetAllStudentsInput
 */
export class GetAllStudentsInput extends Message<GetAllStudentsInput> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "lib.scrapers.powerschool.GetAllStudentsInput";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
