...
// @generated from file lib/scrapers/powerschool/query_schedule.proto (package lib.scrapers.powerschool, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message lib.scrapers.powerschool.CourseMeeting
 */
export class CourseMeeting extends Message<CourseMeeting> {
  ...
  static readonly typeName = "lib.scrapers.powerschool.CourseMeeting";
...
/**
 * @generated from message lib.scrapers.powerschool.CourseMeetingList
 */
export class CourseMeetingList extends Message<CourseMeetingList> {
  /**
   * @generated from field: repeated lib.scrapers.powerschool.CourseMeeting section_meetings = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "lib.scrapers.powerschool.CourseMeetingList";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message lib.scrapers.powerschool.GetCourseMeetingListInput
 */
export class GetCourseMeetingListInput extends Message<GetCourseMeetingListInput> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "lib.scrapers.powerschool.GetCourseMeetingListInput";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
